...
hi("@markup.link.url",        { fg = c.fg2,    underline = true })
hi("@markup.raw",             { fg = c.fg1,    bg = c.bg2 })
...
hi("@lsp.type.interface",     { fg = c.fg0,    italic = true })
hi("@lsp.type.keyword",       { fg = c.mid,    bold = true })
